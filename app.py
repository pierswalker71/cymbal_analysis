...
6. The spectral flatness is <b>{metrics['overall_spectral_flatness']:,.0f}</b> and zero crossing rate is <b>{metrics['overall_zero_crossing_rate']:,.0f}</b> (measures of how noiselike the sound is)<br>
